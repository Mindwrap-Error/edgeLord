...
\noindent If the total penalty is minimized by adding this path, we permanently add this path to the dynamic set. We repeat this process until we have K paths in our dynamic set or we exhaust all candidate paths. Finally we return the paths in the dynamic set as our answer.
